 ...
 *   <li>{@link org.thingml.xtext.thingML.impl.NN_MultilayerPerceptronImpl#getHidden_layers_activation_functions <em>Hidden layers activation functions</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.NN_MultilayerPerceptronImpl#getActivations <em>Activations</em>}</li>
 ...
 *   <li>{@link org.thingml.xtext.thingML.impl.NN_MultilayerPerceptronImpl#getPower <em>Power</em>}</li>
...
public class NN_MultilayerPerceptronImpl extends ML2_ModelAlgorithmImpl implements NN_MultilayerPerceptron
{
  ...
  /**
   * The default value of the '{@link #getHidden_layers_activation_functions() <em>Hidden layers activation functions</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getHidden_layers_activation_functions()
   * @generated
   * @ordered
   */
  protected static final String HIDDEN_LAYERS_ACTIVATION_FUNCTIONS_EDEFAULT = null;

  /**
   * The cached value of the '{@link #getHidden_layers_activation_functions() <em>Hidden layers activation functions</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getHidden_layers_activation_functions()
   * @generated
   * @ordered
   */
  protected String hidden_layers_activation_functions = HIDDEN_LAYERS_ACTIVATION_FUNCTIONS_EDEFAULT;

  /**
   * The cached value of the '{@link #getActivations() <em>Activations</em>}' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getActivations()
   * @generated
   ...
   */
  @Override
  public String getHidden_layers_activation_functions()
  {
    return hidden_layers_activation_functions;
  }
   ...
   */
  @Override
  public void setHidden_layers_activation_functions(String newHidden_layers_activation_functions)
  {
    String oldHidden_layers_activation_functions = hidden_layers_activation_functions;
    hidden_layers_activation_functions = newHidden_layers_activation_functions;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.NN_MULTILAYER_PERCEPTRON__HIDDEN_LAYERS_ACTIVATION_FUNCTIONS, oldHidden_layers_activation_functions, hidden_layers_activation_functions));
  }
  ...
  public EList<Activation> getActivations()
  {
    if (activations == null)
    {
      activations = new EDataTypeEList<Activation>(Activation.class, this, ThingMLPackage.NN_MULTILAYER_PERCEPTRON__ACTIVATIONS);
    }
    return activations;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetPower(DoubleLiteral newPower, NotificationChain msgs)
  {
    DoubleLiteral oldPower = power;
    power = newPower;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.NN_MULTILAYER_PERCEPTRON__POWER, oldPower, newPower);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   */
  @Override
  public void setPower(DoubleLiteral newPower)
  {
    if (newPower != power)
    {
      NotificationChain msgs = null;
      if (power != null)
        msgs = ((InternalEObject)power).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.NN_MULTILAYER_PERCEPTRON__POWER, null, msgs);
      if (newPower != null)
        msgs = ((InternalEObject)newPower).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.NN_MULTILAYER_PERCEPTRON__POWER, null, msgs);
      msgs = basicSetPower(newPower, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.NN_MULTILAYER_PERCEPTRON__POWER, newPower, newPower));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__HIDDEN_LAYERS_ACTIVATION_FUNCTIONS:
        return getHidden_layers_activation_functions();
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__ACTIVATION:
        ...
        return;
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__HIDDEN_LAYERS_ACTIVATION_FUNCTIONS:
        setHidden_layers_activation_functions((String)newValue);
        return;
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__ACTIVATIONS:
      ...
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__LEARNING_RATE_INIT:
        ...
        return;
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__POWER:
        setPower((DoubleLiteral)newValue);
        return;
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__POWER_T:
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__ACTIVATION:
        ...
        return;
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__HIDDEN_LAYERS_ACTIVATION_FUNCTIONS:
        setHidden_layers_activation_functions(HIDDEN_LAYERS_ACTIVATION_FUNCTIONS_EDEFAULT);
        return;
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__ACTIVATIONS:
        getActivations().clear();
        return;
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__HIDDEN_LAYERS_ACTIVATION_FUNCTIONS:
        return HIDDEN_LAYERS_ACTIVATION_FUNCTIONS_EDEFAULT == null ? hidden_layers_activation_functions != null : !HIDDEN_LAYERS_ACTIVATION_FUNCTIONS_EDEFAULT.equals(hidden_layers_activation_functions);
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON__ACTIVATIONS:
  ...
  public String toString()
  {
    ...
    result.append(activation);
    result.append(", hidden_layers_activation_functions: ");
    result.append(hidden_layers_activation_functions);
