 ...
 *   <li>{@link org.thingml.xtext.thingML.NN_MultilayerPerceptron#getHidden_layers_activation_functions <em>Hidden layers activation functions</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.NN_MultilayerPerceptron#getActivations <em>Activations</em>}</li>
 ...
 *   <li>{@link org.thingml.xtext.thingML.NN_MultilayerPerceptron#getPower <em>Power</em>}</li>
 ...
 * @generated
 */
public interface NN_MultilayerPerceptron extends ML2_ModelAlgorithm, ClassifierWithPredictionCertaintyProbabilities
{
  /**
  ...
  /**
   * Returns the value of the '<em><b>Hidden layers activation functions</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Hidden layers activation functions</em>' attribute.
   * @see #setHidden_layers_activation_functions(String)
   * @see org.thingml.xtext.thingML.ThingMLPackage#getNN_MultilayerPerceptron_Hidden_layers_activation_functions()
   * @model
   * @generated
   */
  String getHidden_layers_activation_functions();

  /**
   * Sets the value of the '{@link org.thingml.xtext.thingML.NN_MultilayerPerceptron#getHidden_layers_activation_functions <em>Hidden layers activation functions</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Hidden layers activation functions</em>' attribute.
   * @see #getHidden_layers_activation_functions()
   * @generated
   */
  void setHidden_layers_activation_functions(String value);

  /**
   * Returns the value of the '<em><b>Activations</b></em>' attribute list.
   * The list contents are of type {@link org.thingml.xtext.thingML.Activation}.
   * The literals are from the enumeration {@link org.thingml.xtext.thingML.Activation}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Activations</em>' attribute list.
   * @see org.thingml.xtext.thingML.Activation
   * @see org.thingml.xtext.thingML.ThingMLPackage#getNN_MultilayerPerceptron_Activations()
   * @model unique="false"
   * @generated
   */
   ...
   * @see #setPower(DoubleLiteral)
   * @see org.thingml.xtext.thingML.ThingMLPackage#getNN_MultilayerPerceptron_Power()
   * @model containment="true"
   * @generated
   */
  DoubleLiteral getPower();

  /**
   * Sets the value of the '{@link org.thingml.xtext.thingML.NN_MultilayerPerceptron#getPower <em>Power</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setPower(DoubleLiteral value);
