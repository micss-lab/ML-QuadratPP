...
public class ThingMLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ThingMLPackage.TIME_SERIES_MODEL_ALGORITHM:
      {
        Time_series_ModelAlgorithm time_series_ModelAlgorithm = (Time_series_ModelAlgorithm)theEObject;
        T result = caseTime_series_ModelAlgorithm(time_series_ModelAlgorithm);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(time_series_ModelAlgorithm);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.DEEP_LEARNING_MODEL_ALGORITHM:
      {
        Deep_learning_ModelAlgorithm deep_learning_ModelAlgorithm = (Deep_learning_ModelAlgorithm)theEObject;
        T result = caseDeep_learning_ModelAlgorithm(deep_learning_ModelAlgorithm);
        if (result == null) result = caseTime_series_ModelAlgorithm(deep_learning_ModelAlgorithm);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(deep_learning_ModelAlgorithm);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.STATISTICAL_MODEL_ALGORITHM:
      {
        statistical_ModelAlgorithm statistical_ModelAlgorithm = (statistical_ModelAlgorithm)theEObject;
        T result = casestatistical_ModelAlgorithm(statistical_ModelAlgorithm);
        if (result == null) result = caseTime_series_ModelAlgorithm(statistical_ModelAlgorithm);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(statistical_ModelAlgorithm);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.MACHINE_LEARNING_MODEL_ALGORITHM:
      {
        machine_learning_ModelAlgorithm machine_learning_ModelAlgorithm = (machine_learning_ModelAlgorithm)theEObject;
        T result = casemachine_learning_ModelAlgorithm(machine_learning_ModelAlgorithm);
        if (result == null) result = caseTime_series_ModelAlgorithm(machine_learning_ModelAlgorithm);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(machine_learning_ModelAlgorithm);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.HYBRID_MODEL_ALGORITHM:
      {
        hybrid_ModelAlgorithm hybrid_ModelAlgorithm = (hybrid_ModelAlgorithm)theEObject;
        T result = casehybrid_ModelAlgorithm(hybrid_ModelAlgorithm);
        if (result == null) result = caseTime_series_ModelAlgorithm(hybrid_ModelAlgorithm);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(hybrid_ModelAlgorithm);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.MLP:
      {
        MLP mlp = (MLP)theEObject;
        T result = caseMLP(mlp);
        if (result == null) result = caseDeep_learning_ModelAlgorithm(mlp);
        if (result == null) result = caseTime_series_ModelAlgorithm(mlp);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(mlp);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.GRU:
      {
        GRU gru = (GRU)theEObject;
        T result = caseGRU(gru);
        if (result == null) result = caseDeep_learning_ModelAlgorithm(gru);
        if (result == null) result = caseTime_series_ModelAlgorithm(gru);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(gru);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.CNN:
      {
        CNN cnn = (CNN)theEObject;
        T result = caseCNN(cnn);
        if (result == null) result = caseDeep_learning_ModelAlgorithm(cnn);
        if (result == null) result = caseTime_series_ModelAlgorithm(cnn);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(cnn);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.LSTM:
      {
        LSTM lstm = (LSTM)theEObject;
        T result = caseLSTM(lstm);
        if (result == null) result = caseDeep_learning_ModelAlgorithm(lstm);
        if (result == null) result = caseTime_series_ModelAlgorithm(lstm);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(lstm);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.RNN:
      {
        RNN rnn = (RNN)theEObject;
        T result = caseRNN(rnn);
        if (result == null) result = caseDeep_learning_ModelAlgorithm(rnn);
        if (result == null) result = caseTime_series_ModelAlgorithm(rnn);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(rnn);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.TCN:
      {
        TCN tcn = (TCN)theEObject;
        T result = caseTCN(tcn);
        if (result == null) result = caseDeep_learning_ModelAlgorithm(tcn);
        if (result == null) result = caseTime_series_ModelAlgorithm(tcn);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(tcn);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.TRANSFORMER:
      {
        Transformer transformer = (Transformer)theEObject;
        T result = caseTransformer(transformer);
        if (result == null) result = caseDeep_learning_ModelAlgorithm(transformer);
        if (result == null) result = caseTime_series_ModelAlgorithm(transformer);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(transformer);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.ARIMA:
      {
        ARIMA arima = (ARIMA)theEObject;
        T result = caseARIMA(arima);
        if (result == null) result = casestatistical_ModelAlgorithm(arima);
        if (result == null) result = caseTime_series_ModelAlgorithm(arima);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(arima);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.SARIMA:
      {
        SARIMA sarima = (SARIMA)theEObject;
        T result = caseSARIMA(sarima);
        if (result == null) result = casestatistical_ModelAlgorithm(sarima);
        if (result == null) result = caseTime_series_ModelAlgorithm(sarima);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(sarima);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.HWES:
      {
        HWES hwes = (HWES)theEObject;
        T result = caseHWES(hwes);
        if (result == null) result = casestatistical_ModelAlgorithm(hwes);
        if (result == null) result = caseTime_series_ModelAlgorithm(hwes);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(hwes);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.ETS:
      {
        ETS ets = (ETS)theEObject;
        T result = caseETS(ets);
        if (result == null) result = casestatistical_ModelAlgorithm(ets);
        if (result == null) result = caseTime_series_ModelAlgorithm(ets);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(ets);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.STATE_SPACE_MODEL:
      {
        StateSpaceModel stateSpaceModel = (StateSpaceModel)theEObject;
        T result = caseStateSpaceModel(stateSpaceModel);
        if (result == null) result = casestatistical_ModelAlgorithm(stateSpaceModel);
        if (result == null) result = caseTime_series_ModelAlgorithm(stateSpaceModel);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(stateSpaceModel);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.SVR:
      {
        SVR svr = (SVR)theEObject;
        T result = caseSVR(svr);
        if (result == null) result = casemachine_learning_ModelAlgorithm(svr);
        if (result == null) result = caseTime_series_ModelAlgorithm(svr);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(svr);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.RFR:
      {
        RFR rfr = (RFR)theEObject;
        T result = caseRFR(rfr);
        if (result == null) result = casemachine_learning_ModelAlgorithm(rfr);
        if (result == null) result = caseTime_series_ModelAlgorithm(rfr);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(rfr);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.GBM:
      {
        GBM gbm = (GBM)theEObject;
        T result = caseGBM(gbm);
        if (result == null) result = casemachine_learning_ModelAlgorithm(gbm);
        if (result == null) result = caseTime_series_ModelAlgorithm(gbm);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(gbm);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.XG_BOOST:
      {
        XGBoost xgBoost = (XGBoost)theEObject;
        T result = caseXGBoost(xgBoost);
        if (result == null) result = casemachine_learning_ModelAlgorithm(xgBoost);
        if (result == null) result = caseTime_series_ModelAlgorithm(xgBoost);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(xgBoost);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.ARIMA_GARCH:
      {
        ARIMA_GARCH arimA_GARCH = (ARIMA_GARCH)theEObject;
        T result = caseARIMA_GARCH(arimA_GARCH);
        if (result == null) result = casehybrid_ModelAlgorithm(arimA_GARCH);
        if (result == null) result = caseTime_series_ModelAlgorithm(arimA_GARCH);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(arimA_GARCH);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.PROPHET:
      {
        Prophet prophet = (Prophet)theEObject;
        T result = caseProphet(prophet);
        if (result == null) result = casehybrid_ModelAlgorithm(prophet);
        if (result == null) result = caseTime_series_ModelAlgorithm(prophet);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(prophet);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ThingMLPackage.CLASSIFIER_WITH_PREDICTION_CERTAINTY_PROBABILITIES:
      {
        ClassifierWithPredictionCertaintyProbabilities classifierWithPredictionCertaintyProbabilities = (ClassifierWithPredictionCertaintyProbabilities)theEObject;
        T result = caseClassifierWithPredictionCertaintyProbabilities(classifierWithPredictionCertaintyProbabilities);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ThingMLPackage.LINEAR_CLASSIFIER_LOGISTIC_REGRESSION:
      {
        ...
        if (result == null) result = caseClassifierWithPredictionCertaintyProbabilities(linearClassifierLogisticRegression);
      ...
      case ThingMLPackage.NAIVE_BAYES_GAUSSIAN:
      {
        ...
        if (result == null) result = caseClassifierWithPredictionCertaintyProbabilities(naiveBayesGaussian);
      ...
      case ThingMLPackage.NAIVE_BAYES_MULTINOMIAL:
      {
        ...
        if (result == null) result = caseClassifierWithPredictionCertaintyProbabilities(naiveBayesMultinomial);
      ...
      case ThingMLPackage.NAIVE_BAYES_COMPLEMENT:
      {
        ...
        if (result == null) result = caseClassifierWithPredictionCertaintyProbabilities(naiveBayesComplement);
      ...
      case ThingMLPackage.NAIVE_BAYES_BERNOULLI:
      {
        ...
        if (result == null) result = caseClassifierWithPredictionCertaintyProbabilities(naiveBayesBernoulli);
      ...
      case ThingMLPackage.NAIVE_BAYES_CATEGORICAL:
      {
        ...
        if (result == null) result = caseClassifierWithPredictionCertaintyProbabilities(naiveBayesCategorical);
      ...
      case ThingMLPackage.DECISION_TREE_CLASSIFIER:
      {
        ...
        if (result == null) result = caseClassifierWithPredictionCertaintyProbabilities(decisionTreeClassifier);
      ...
      case ThingMLPackage.NN_MULTILAYER_PERCEPTRON:
      {
        ...
        if (result == null) result = caseClassifierWithPredictionCertaintyProbabilities(nN_MultilayerPerceptron);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(nN_MultilayerPerceptron);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.KMEANS:
      {
        KMeans kMeans = (KMeans)theEObject;
        T result = caseKMeans(kMeans);
        if (result == null) result = caseML2_ModelAlgorithm(kMeans);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(kMeans);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.MINI_BATCH_KMEANS:
      {
        MiniBatchKMeans miniBatchKMeans = (MiniBatchKMeans)theEObject;
        T result = caseMiniBatchKMeans(miniBatchKMeans);
        if (result == null) result = caseML2_ModelAlgorithm(miniBatchKMeans);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(miniBatchKMeans);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.DBSCAN:
      {
        DBSCAN dbscan = (DBSCAN)theEObject;
        T result = caseDBSCAN(dbscan);
        if (result == null) result = caseML2_ModelAlgorithm(dbscan);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(dbscan);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.SPECTRAL_CLUSTERING:
      {
        SpectralClustering spectralClustering = (SpectralClustering)theEObject;
        T result = caseSpectralClustering(spectralClustering);
        if (result == null) result = caseML2_ModelAlgorithm(spectralClustering);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(spectralClustering);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.GAUSSIAN_MIXTURE:
      {
        GaussianMixture gaussianMixture = (GaussianMixture)theEObject;
        T result = caseGaussianMixture(gaussianMixture);
        if (result == null) result = caseML2_ModelAlgorithm(gaussianMixture);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(gaussianMixture);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.SELF_TRAINING_CLASSIFIER:
      {
        SelfTrainingClassifier selfTrainingClassifier = (SelfTrainingClassifier)theEObject;
        T result = caseSelfTrainingClassifier(selfTrainingClassifier);
        if (result == null) result = caseML2_ModelAlgorithm(selfTrainingClassifier);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(selfTrainingClassifier);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.LABEL_PROPAGATION:
      {
        LabelPropagation labelPropagation = (LabelPropagation)theEObject;
        T result = caseLabelPropagation(labelPropagation);
        if (result == null) result = caseML2_ModelAlgorithm(labelPropagation);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(labelPropagation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.LABEL_SPREADING:
      {
        LabelSpreading labelSpreading = (LabelSpreading)theEObject;
        T result = caseLabelSpreading(labelSpreading);
        if (result == null) result = caseML2_ModelAlgorithm(labelSpreading);
        if (result == null) result = caseDataAnalyticsModelAlgorithm(labelSpreading);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case ThingMLPackage.DA_PRE_TRAINED_PREDICT_ACTION:
      {
        DAPreTrainedPredictAction daPreTrainedPredictAction = (DAPreTrainedPredictAction)theEObject;
        T result = caseDAPreTrainedPredictAction(daPreTrainedPredictAction);
        if (result == null) result = caseAction(daPreTrainedPredictAction);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ThingMLPackage.DA_FORECAST_ACTION:
      {
        DAForecastAction daForecastAction = (DAForecastAction)theEObject;
        T result = caseDAForecastAction(daForecastAction);
        if (result == null) result = caseAction(daForecastAction);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Time series Model Algorithm</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Time series Model Algorithm</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseTime_series_ModelAlgorithm(Time_series_ModelAlgorithm object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Deep learning Model Algorithm</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Deep learning Model Algorithm</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDeep_learning_ModelAlgorithm(Deep_learning_ModelAlgorithm object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>statistical Model Algorithm</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>statistical Model Algorithm</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casestatistical_ModelAlgorithm(statistical_ModelAlgorithm object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>machine learning Model Algorithm</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>machine learning Model Algorithm</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casemachine_learning_ModelAlgorithm(machine_learning_ModelAlgorithm object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>hybrid Model Algorithm</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>hybrid Model Algorithm</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casehybrid_ModelAlgorithm(hybrid_ModelAlgorithm object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>CNN</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>CNN</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseCNN(CNN object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>TCN</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>TCN</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseTCN(TCN object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>SARIMA</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>SARIMA</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseSARIMA(SARIMA object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>HWES</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>HWES</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseHWES(HWES object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>ETS</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>ETS</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseETS(ETS object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>State Space Model</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>State Space Model</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseStateSpaceModel(StateSpaceModel object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>RFR</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>RFR</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRFR(RFR object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>GBM</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>GBM</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseGBM(GBM object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>XG Boost</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>XG Boost</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>ARIMA GARCH</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>ARIMA GARCH</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseARIMA_GARCH(ARIMA_GARCH object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Prophet</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Prophet</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseProphet(Prophet object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Classifier With Prediction Certainty Probabilities</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Classifier With Prediction Certainty Probabilities</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseClassifierWithPredictionCertaintyProbabilities(ClassifierWithPredictionCertaintyProbabilities object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Mini Batch KMeans</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Mini Batch KMeans</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseMiniBatchKMeans(MiniBatchKMeans object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Spectral Clustering</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Spectral Clustering</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseSpectralClustering(SpectralClustering object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Gaussian Mixture</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Gaussian Mixture</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseGaussianMixture(GaussianMixture object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Self Training Classifier</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Self Training Classifier</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseSelfTrainingClassifier(SelfTrainingClassifier object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Label Propagation</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Label Propagation</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseLabelPropagation(LabelPropagation object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Label Spreading</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Label Spreading</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseLabelSpreading(LabelSpreading object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>DA Pre Trained Predict Action</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>DA Pre Trained Predict Action</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDAPreTrainedPredictAction(DAPreTrainedPredictAction object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>DA Forecast Action</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>DA Forecast Action</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDAForecastAction(DAForecastAction object)
  {
    return null;
  }
