 ...
 * </p>
 * <ul>
 *   <li>{@link org.thingml.xtext.thingML.impl.GRUImpl#getReturn_sequences <em>Return sequences</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GRUImpl#getHidden_layer_sizes <em>Hidden layer sizes</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GRUImpl#getHidden_layers <em>Hidden layers</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GRUImpl#getInput_activation <em>Input activation</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GRUImpl#getHidden_activation <em>Hidden activation</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GRUImpl#getOutput_activation <em>Output activation</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GRUImpl#getRegularization <em>Regularization</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GRUImpl#getDropout <em>Dropout</em>}</li>
 *   <li>{@link org.thingml.xtext.thingML.impl.GRUImpl#getRate <em>Rate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GRUImpl extends Deep_learning_ModelAlgorithmImpl implements GRU
{
  /**
  ...
  {
    return ThingMLPackage.eINSTANCE.getGRU();
  }
  ...
  public NotificationChain basicSetReturn_sequences(BooleanLiteral newReturn_sequences, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ThingMLPackage.GRU__RETURN_SEQUENCES, oldReturn_sequences, newReturn_sequences);
  ...
  public void setReturn_sequences(BooleanLiteral newReturn_sequences)
  {
    if (newReturn_sequences != return_sequences)
    {
      ...
      if (return_sequences != null)
        msgs = ((InternalEObject)return_sequences).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.GRU__RETURN_SEQUENCES, null, msgs);
      if (newReturn_sequences != null)
        msgs = ((InternalEObject)newReturn_sequences).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ThingMLPackage.GRU__RETURN_SEQUENCES, null, msgs);
      msgs = basicSetReturn_sequences(newReturn_sequences, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GRU__RETURN_SEQUENCES, newReturn_sequences, newReturn_sequences));
  }
  ...
  public void setHidden_layer_sizes(String newHidden_layer_sizes)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GRU__HIDDEN_LAYER_SIZES, oldHidden_layer_sizes, hidden_layer_sizes));
  }
  ...
  public EList<IntegerLiteral> getHidden_layers()
  {
    ...
    {
      hidden_layers = new EObjectContainmentEList<IntegerLiteral>(IntegerLiteral.class, this, ThingMLPackage.GRU__HIDDEN_LAYERS);
    }
  ...
  public void setInput_activation(Activation newInput_activation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GRU__INPUT_ACTIVATION, oldInput_activation, input_activation));
  }
  ...
  public void setHidden_activation(Activation newHidden_activation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GRU__HIDDEN_ACTIVATION, oldHidden_activation, hidden_activation));
  }
  ...
  public void setOutput_activation(Activation newOutput_activation)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GRU__OUTPUT_ACTIVATION, oldOutput_activation, output_activation));
  }
  ...
  public void setRegularization(Regularization newRegularization)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GRU__REGULARIZATION, oldRegularization, regularization));
  }
  ...
  public void setDropout(double newDropout)
  {
    ...
    dropout = newDropout;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GRU__DROPOUT, oldDropout, dropout));
  }
  ...
  public void setRate(double newRate)
  {
    ...
    rate = newRate;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ThingMLPackage.GRU__RATE, oldRate, rate));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ThingMLPackage.GRU__RETURN_SEQUENCES:
        return basicSetReturn_sequences(null, msgs);
      case ThingMLPackage.GRU__HIDDEN_LAYERS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ThingMLPackage.GRU__HIDDEN_LAYER_SIZES:
        return getHidden_layer_sizes();
      case ThingMLPackage.GRU__HIDDEN_LAYERS:
        return getHidden_layers();
      case ThingMLPackage.GRU__INPUT_ACTIVATION:
        return getInput_activation();
      case ThingMLPackage.GRU__HIDDEN_ACTIVATION:
        return getHidden_activation();
      case ThingMLPackage.GRU__OUTPUT_ACTIVATION:
        return getOutput_activation();
      case ThingMLPackage.GRU__REGULARIZATION:
        return getRegularization();
      case ThingMLPackage.GRU__DROPOUT:
        return getDropout();
      case ThingMLPackage.GRU__RATE:
        return getRate();
    }
